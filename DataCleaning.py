...
after = df_model.dropna(subset=['tgtsNext', 'recNext'])
dropped = before.loc[~before.index.isin(after.index)]
...
df_2025_sorted[['name_x', 'team', 'projTgts_2025', 'projRec_2025', 'projYds_2025', 'projTD_2025', 'projFantasyPts_2025']].to_csv("BrandNewPredictions20244.csv")